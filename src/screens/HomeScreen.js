...
const _map =useRef(1);
  ...
  return (
    <View style={styles.container}>
            ...
            <View>
                    ...
                    <View style={styles.view5}>
                        <View style={styles.view6}>
                            ...
                            <View >
                            <Text style ={{fontSize:18, color:colors.black}}>San Francisco, CA</Text>
                            <Text style ={{color:colors.grey3}}>3, Border Street</Text>
                            </View>
                            <View>
                            <Icon type='material-community' 
                            name='chevron-right'
      ...
      <StatusBar style='light' backgroundColor='#2850c0' translucent={true} />
    </View>
  )
}
